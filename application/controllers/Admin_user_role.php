...
class Admin_user_role extends CI_Controller
{
  ...
  /**
   * @description Menampilkan halaman Role (user role)
   *
   * @return void
   */
  ...
  /**
   * @description Menampilkan halaman tambah data & add data Role (user role)
   *
  ...
  /**
   * @description Delete data Role (user role)
   *
   * @param string $id
   * @return void
   */
  ...
  /**
   * @description Update data Role (user role)
   *
   * @param string $id
   * @return void
   */
